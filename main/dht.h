...
#define _DHT_ZERO_BIT_MIN_INTERVAL_RANGE 68
#define _DHT_ZERO_BIT_MAX_INTERVAL_RANGE 84
#define _DHT_ONE_BIT_MIN_INTERVAL_RANGE 118
#define _DHT_ONE_BIT_MAX_INTERVAL_RANGE 134
